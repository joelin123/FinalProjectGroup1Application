        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <P align="right"> <a href="<c:url value='/queryCar'/>">查看所有車輛</a> 
                    </P>
                   <!-- 
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">修改租車車輛</h6>
                        </div>
                        <div class="card-body">
	...
	<!-- <c:choose>
	 ...
	 <tr>
	  ...
	  <div class="form-group row"> 
	   ...
	   <tr>
	      <td>編號：</td>
	      <td  width=''>
	      	<form:input path="Id" style='width:100%;height:40px;' readonly="readonly" /><br>&nbsp;	
	   ...
	   <tr>
	    ...
	    <tr>
	      <td>座位：</td>
	      <td  width='360'>
	      	<form:input path="seat" style='width:100%;height:40px;' /><br>&nbsp;	
	 ...
	 <div class="form-group row"> 
	   ...
	   <tr>
	      <td>行李箱：</td>
	        <td  width=''>
	      	<form:input path="suitcase" style='width:100%;height:40px;' /><br>&nbsp;	
		      <form:errors path='suitcase' cssClass="error"/>
		  </td>
		  </tr>
		 </div>
		 <div class="col-sm-6">
		 <tr>
	      <td>手提袋：</td>
		  <td  width=''>
		  <form:input path='handbag' style='width:100%;height:40px;' /><br>&nbsp;	
		      <form:errors path='handbag' cssClass="error"/>
		  </td>
	   </tr>
	 </div> 
	 </div>
